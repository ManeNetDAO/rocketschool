...
export const videos: Array<ElemData> = [
  ...
  {
    title: '2.3 Securing your Node',
    about:
      'Set up SSH, disable password login, set up a firewall, and consider several more advanced security options',
    url: 'https://www.youtube.com/embed/bQK9Yr1BpQw',
  },
  {
    title: '2.4 Installing Rocket Pool',
    about:
      'Install Docker, download the Rocket Pool CLI, and install the Smartnode Stack',
    url: 'https://www.youtube.com/embed/bQK9Yr1BpQw',
  },
  {
